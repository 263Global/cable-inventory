...
export const salesStatusBadgeClass: Record<SalesStatus, string> = {
    ...
    'Pre-sold': 'bg-amber-500/15 text-amber-700 dark:text-amber-400',
...
export const resourceTypeBadgeClass: Record<ResourceType, string> = {
    ...
    'Spectrum': 'bg-purple-500/15 text-purple-700 dark:text-purple-400',
}
...
export const resourceTypeTextClass: Record<ResourceType, string> = {
    ...
    'Fiber': 'text-warning',
    'Spectrum': 'text-purple-700 dark:text-purple-400',
}
