                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${typeColors[resource.type]}`}>
                                {resource.type}
                            </span>
                            <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${statusColors[resource.status]}`}>
                                {resource.status}
                            </span>
                        </div>
                        {resource.internal_ref && (
                            <p className="text-sm text-text-dim mt-1">{resource.internal_ref}</p>
                        )}
                    </div>
                </div>
            ...
            <div className="space-y-6">
                ...
                <div className="bg-surface rounded-xl border border-border-subtle p-6">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex-1 text-center p-4 bg-background rounded-lg">
                    ...
                    {resource.route_description && (
                        <p className="text-sm text-text-muted mt-3">{resource.route_description}</p>
                    )}
                </div>
