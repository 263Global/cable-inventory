    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <h1 className="text-2xl font-bold">Add Inventory Resource</h1>
            </div>
            ...
            <div className="flex items-center gap-4 mb-8">
                {steps.map((s, i) => (
                    <div key={s} className="flex items-center gap-2">
                        ...
                        {i < steps.length - 1 && <div className={`w-8 h-px ${i < step ? 'bg-primary' : 'bg-border-subtle'}`} />}
                    </div>
                ))}
            </div>
                ...
                <div className="flex items-center justify-between mt-6 pt-4 border-t border-border-subtle">
                    ...
                    {step < steps.length - 1 ? (
                        ...
                        <button onClick={handleSave} disabled={saving || (isBatchMode && batchCapacityExceeded)}
                            ...
                            <Check className="h-4 w-4" /> Create Resource
                        </button>
                    )}
                </div>
            </div>
